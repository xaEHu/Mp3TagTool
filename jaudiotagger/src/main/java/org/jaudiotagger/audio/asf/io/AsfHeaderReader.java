...
public class AsfHeaderReader extends ChunkContainerReader<AsfHeader>
{
    ...
    public static AsfHeader readInfoHeader(final InputStream inputStream) throws IOException
    {
        return INFO_READER.read(Utils.readGUID(inputStream), inputStream, 0);
    }
    ...
    public static AsfHeader readTagHeader(final InputStream inputStream) throws IOException
    {
        return TAG_READER.read(Utils.readGUID(inputStream), inputStream, 0);
    }
    /**
