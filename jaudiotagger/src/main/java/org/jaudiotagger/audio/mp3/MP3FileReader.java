...
public class MP3FileReader extends AudioFileReader
{
    ...
    public AudioFile read(Context context, Uri uri) throws CannotReadException, IOException, TagException, ReadOnlyFileException, InvalidAudioFrameException {
        MP3File mp3File = new MP3File(context,uri,MP3File.LOAD_IDV1TAG | MP3File.LOAD_IDV2TAG, true);
        return mp3File;
    }
    ...
    public AudioFile readMustBeWritable(Context context, Uri uri) throws IOException, TagException, ReadOnlyFileException, CannotReadException, InvalidAudioFrameException
    {
        MP3File mp3File = new MP3File(context,uri, MP3File.LOAD_IDV1TAG | MP3File.LOAD_IDV2TAG, false);
        return mp3File;
    }
