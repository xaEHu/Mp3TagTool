...
public class Mp4TagReader
{
    ...
    {
        return read(raf.getChannel());
    }

    public Mp4Tag read(Context context, Uri uri) throws CannotReadException, IOException
    {
        return read(ContextUtils.getParcelInputStream(context, uri).getChannel());
    }
    public Mp4Tag read(FileChannel fc) throws IOException, CannotReadException {
