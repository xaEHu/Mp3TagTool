...
public class Mp4InfoReader
{
    ...
    {
        FileChannel fc = ContextUtils.getParcelInputStream(context, uri).getChannel();
        return read(fc);
    }

    @NotNull
    public GenericAudioHeader read(FileChannel fc) throws IOException, CannotReadException {
