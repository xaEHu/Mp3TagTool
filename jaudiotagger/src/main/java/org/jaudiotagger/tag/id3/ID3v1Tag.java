...
public class ID3v1Tag extends AbstractID3v1Tag implements Tag
{
    ...
    public ID3v1Tag(RandomAccessFile file, String loggingFilename) throws TagNotFoundException, IOException
    {
        FileChannel fc;
        fc = file.getChannel();
        init(loggingFilename, fc);
    }

    public void init(String loggingFilename, FileChannel fc) throws IOException, TagNotFoundException {
    ...
    public ID3v1Tag(Context context, Uri uri, String loggingFilename) throws TagNotFoundException, IOException, CannotReadException
    {
        init(loggingFilename, ContextUtils.getParcelInputStream(context, uri).getChannel());
    }
