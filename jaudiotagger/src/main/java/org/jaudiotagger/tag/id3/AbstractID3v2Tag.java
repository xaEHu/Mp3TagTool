...
public abstract class AbstractID3v2Tag extends AbstractID3Tag implements Tag
{
    ...
    */
    ...
    {
        return getV2TagSizeIfExists(new FileInputStream(file));
    }

    public static long getV2TagSizeIfExists(Context context, Uri uri) throws IOException, CannotReadException
    {
        return getV2TagSizeIfExists(ContextUtils.getParcelInputStream(context, uri));
    }

    public static long getV2TagSizeIfExists(FileInputStream fis) throws IOException
    {
        FileChannel fc = null;
        ByteBuffer bb = null;
        try
