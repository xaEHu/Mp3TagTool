...
public class ID3v11Tag extends ID3v1Tag
{
    ...
    {
        init(file.getChannel(),loggingFilename);

    }

    public void init(FileChannel fc,String loggingFilename) throws IOException, TagNotFoundException {
    ...
    public ID3v11Tag(Context context, Uri uri, String loggingFilename) throws TagNotFoundException, IOException, CannotReadException
    {
        init(ContextUtils.getParcelInputStream(context, uri).getChannel(),loggingFilename);
    }
